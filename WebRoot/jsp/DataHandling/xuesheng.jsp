...
<html>
  <head>
    ...
    <title>My JSP 'xuesheng.jsp' starting page</title>
  ...
  <body>
     <% 
         ...
         String CID = request.getParameter("zhanghao");
         String Cmima = request.getParameter("mima");
      %>
    <% 
      Connection con;
   	  Statement sql;
   	  ...
   	  String sal="select * from xuesheng where ID='"+CID+"' or mima='"+Cmima+"' ";
   	  ResultSet rs=stmt.executeQuery(sal);
   	       if(rs.next()){  	       
   	                               ...
   	                               session.setAttribute("banji",rs.getString("banji"));
