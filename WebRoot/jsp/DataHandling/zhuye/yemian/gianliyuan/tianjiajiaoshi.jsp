...
<html>
  <head>
    ...
    <title>My JSP 'tianjiajiaoshi.jsp' starting page</title>
  ...
  <body>
            ...
            <form action="./jsp/DataHandling/zhuye/yemian/gianliyuan/shujiuchuli/tiaonjia.jsp" method="post" id="1" style="position: absolute;left:200px;top:50px;">
                    ...
                    <form action="./jsp/DataHandling/zhuye/yemian/gianliyuan/shujiuchuli/xiugaijiaoshi.jsp" method="post" id="2" style="position: absolute;left:200px;top:50px;display: none;">
                    <table border="1" align="center"  style="text-align: center;">
           ...
           <form action="./jsp/DataHandling/zhuye/yemian/gianliyuan/shujiuchuli/shanchujiaoshi.jsp" method="post" id="3" style="position: absolute;left:400px;top:50px;display: none;">
