...
<html>
  ...
  <body>
       <form action="./jsp/DataHandling/zhuye/yemian/neirong/shujichuli/mimachuli.jsp" method="post" name="xiugai" style="position: absolute;top:200px;left:42%;">
       ...
       <script type="text/javascript">
                   ...
                   function mi(){
                     ...
                     if(document.xiugai.xiugai2.value==""){
                      ...
                      if(document.xiugai.xiugai3.value==""&&document.xiugai.xiugai3.value.length<=6){
                            alert("请输入正确的密码")
